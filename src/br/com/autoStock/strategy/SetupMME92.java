 ...
 * 2) Aguardar 1 fechamento abaixo da mínima da barra anterior e marcar a máxima dessa barra;
 ...
 * Vender a posição remanescente quando a for feito qualquer negócio abaixo da mínima do canlde que fizer a MME9 virar.
 *  
 */
public class SetupMME92 extends Regras {
	...
	/*
	 * MM9 esteja subindo;
	 * Aguardar 1 fechamento abaixo da mínima da barra anterior e marcar a máxima dessa barra;
	 * Caso a máxima não seja rompida, marcar a próxima máxima;
	...
	public float regraCompra(Quote historico, int dataAtual) {
		...
		if(mme9[dataAtual].getClose() > mme9[dataAtual - 2].getClose()
		&& quotes[dataAtual - 1].getClose() < quotes[dataAtual - 2].getLow()
		&& pcStop == 0F){
