...
public class VerticalLine extends AbstractXYAnnotation implements Cloneable, PublicCloneable, Serializable {
	...
	public VerticalLine(double y1, double x2, double y2) {
		this(y1, x2, y2, new BasicStroke(1.0f), Color.black);
	}
	...
	public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea,
		...
		Line2D line = new Line2D.Double(xd1, yd1, xd1, yd2);
