...
public class Evolution extends AbstractXYAnnotation implements Cloneable, PublicCloneable, Serializable {

	static Logger logger = Logger.getLogger(Evolution.class.getName());
	...
	public Evolution(double x1, double y1, double x2, double y2) {
	...
	public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea,
		...
		Line2D line = new Line2D.Double(xd1, yd1, xd2, yd2);
		...
		double variacao = ((this.y2 / this.y1) - 1F)*100F;
		
        TextUtilities.drawRotatedString(String.format("%.2f", variacao)+ "%", g2, 
        		new Double(xd2 + 20).floatValue(), 
        		new Double(yd2).floatValue(), 
		...
		if (toolTip != null || url != null) {
			addEntity(info, ShapeUtilities.createLineRegion(line, 5.0f),
