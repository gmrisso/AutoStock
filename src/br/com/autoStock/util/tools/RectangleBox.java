...
public class RectangleBox extends AbstractXYAnnotation implements Cloneable, PublicCloneable, Serializable {
	...
	public RectangleBox(double x1, double y1, double x2, double y2) {
	...
	public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea,
		...
		Line2D line1 = new Line2D.Double(xd1, yd1, xd2, yd1);
		Line2D line2 = new Line2D.Double(xd2, yd1, xd2, yd2);
		Line2D line3 = new Line2D.Double(xd2, yd2, xd1, yd2);
		Line2D line4 = new Line2D.Double(xd1, yd2, xd1, yd1);

		// line is clipped to avoid JRE bug 6574155, for more info
		// see JFreeChart bug 2221495
		boolean visible = LineUtilities.clipLine(line1, dataArea);
		if (visible) {
			g2.draw(line1);
			g2.draw(line2);
			g2.draw(line3);
		...
		if(this.isSelected){
			...
			g2.fill(box1);			
			Rectangle2D box2 = new Rectangle2D.Double(xd2 - 2, yd1 - 2, 4, 4);			 
			g2.fill(box2);
			Rectangle2D box3 = new Rectangle2D.Double(xd2 - 2, yd2 - 2, 4, 4);			 
			g2.fill(box3);
			Rectangle2D box4 = new Rectangle2D.Double(xd1 - 2, yd2 - 2, 4, 4);			 
			g2.fill(box4);
		}
		...
		if (toolTip != null || url != null) {
			...
			addEntity(info, ShapeUtilities.createLineRegion(line3, 5.0f),rendererIndex, toolTip, url);
			addEntity(info, ShapeUtilities.createLineRegion(line4, 5.0f),rendererIndex, toolTip, url);
		}
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RectangleBox other = (RectangleBox) obj;
		if (dataX1 == null) {
