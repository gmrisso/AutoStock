...
public class HRetFibo extends AbstractXYAnnotation implements Cloneable, PublicCloneable, Serializable {
	...
	public HRetFibo(double x1, double y1, double x2, double y2) {
	...
	public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea,
		...
		double x236 = xd1 +(xd2-xd1) * 0.236;
		double x382 = xd1 +(xd2-xd1) * 0.382;
		double x50  = xd1 +(xd2-xd1) * 0.5;
		double x618 = xd1 +(xd2-xd1) * 0.618;
				
		Line2D line0 	= new Line2D.Double(xd1, yd1, xd1, yd2);
		Line2D line236 	= new Line2D.Double(x236, yd1, x236, yd2);
		Line2D line382 	= new Line2D.Double(x382, yd1, x382, yd2);
		Line2D line50 	= new Line2D.Double(x50, yd1, x50, yd2);
		Line2D line618  = new Line2D.Double(x618, yd1, x618, yd2);
		Line2D line100  = new Line2D.Double(xd2, yd1, xd2, yd2);
		...
		boolean visible = LineUtilities.clipLine(line0, dataArea);
		if (visible) {
			g2.draw(line0);
			g2.draw(line236);
			g2.draw(line382);
		...
		TextUtilities.drawRotatedString("0%",    g2, new Double(xd1).floatValue(), new Double(yd2).floatValue(), TextAnchor.BOTTOM_CENTER, 0.0, TextAnchor.CENTER);
		TextUtilities.drawRotatedString("23,6%", g2, new Double(x236).floatValue(), new Double(yd2).floatValue(), TextAnchor.BOTTOM_CENTER, 0.0, TextAnchor.CENTER);
		TextUtilities.drawRotatedString("38,2%", g2, new Double(x382).floatValue(), new Double(yd2).floatValue(), TextAnchor.BOTTOM_CENTER, 0.0, TextAnchor.CENTER);
		TextUtilities.drawRotatedString("50%",   g2, new Double(x50).floatValue(), new Double(yd2).floatValue(), TextAnchor.BOTTOM_CENTER, 0.0, TextAnchor.CENTER);
		TextUtilities.drawRotatedString("61,8%", g2, new Double(x618).floatValue(), new Double(yd2).floatValue(), TextAnchor.BOTTOM_CENTER, 0.0, TextAnchor.CENTER);
		TextUtilities.drawRotatedString("100%",  g2, new Double(xd2).floatValue(), new Double(yd2).floatValue(), TextAnchor.BOTTOM_CENTER, 0.0, TextAnchor.CENTER);
