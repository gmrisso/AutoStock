...
public class ExtFibo extends AbstractXYAnnotation implements Cloneable, PublicCloneable, Serializable {
	...
	public ExtFibo(double x1, double y1, double x2, double y2) {
	...
	public void draw(Graphics2D g2, XYPlot plot, Rectangle2D dataArea,
		...
		double y1382 = yd1 +(yd2-yd1) * 1.382;
		double y1618 = yd1 +(yd2-yd1) * 1.618;
		double y200  = yd1 +(yd2-yd1) * 2;
		...
		Line2D line1382 = new Line2D.Double(xd1, y1382, xd2, y1382);
		Line2D line1618 = new Line2D.Double(xd1, y1618, xd2, y1618);
		Line2D line200  = new Line2D.Double(xd1, y200, xd2, y200); 
		...
		TextUtilities.drawRotatedString(String.format("%.2f", rangeAxis.java2DToValue(y1382, dataArea,rangeEdge))+ "(138,2%)", g2, 
				new Double(xd2 + 5).floatValue(), new Double(y1382).floatValue(), TextAnchor.BASELINE_LEFT, 0.0, TextAnchor.CENTER);
		TextUtilities.drawRotatedString(String.format("%.2f", rangeAxis.java2DToValue(y1618, dataArea,rangeEdge))+ "(161,8%)", g2, 
				new Double(xd2 + 5).floatValue(), new Double(y1618).floatValue(), TextAnchor.BASELINE_LEFT, 0.0, TextAnchor.CENTER);
		TextUtilities.drawRotatedString(String.format("%.2f", rangeAxis.java2DToValue(y200, dataArea,rangeEdge))+ "(200%)", g2, 
				new Double(xd2 + 5).floatValue(), new Double(y200).floatValue(), TextAnchor.BASELINE_LEFT, 0.0, TextAnchor.CENTER);
		...
		if (toolTip != null || url != null) {
			...
			addEntity(info, ShapeUtilities.createLineRegion(line1382, 5.0f),rendererIndex, toolTip, url);
			addEntity(info, ShapeUtilities.createLineRegion(line1618, 5.0f),rendererIndex, toolTip, url);
			addEntity(info, ShapeUtilities.createLineRegion(line200, 5.0f),rendererIndex, toolTip, url);
		}
	}
